...
<tr style="font-size:20px;text-align:center;border:2px solid black;background-color: #EEA47F;color:white;">
  ...
  <tr>
    ...
    <td>
    <a href="index.php?info=edit_class&class_id=<?php echo$row['id']?>" class="btn btn-primary">Edit</a>
    <a href="index.php?info=classes&delete_id=<?php echo$row['id']?>" class="btn btn-danger">Delete</a>
</td>
  </tr>
  <?php
  $i++;
